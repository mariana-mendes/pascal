...
public class PascalParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PascalGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTypeDefinitionAccess().getIdentifierAssignment_0(), "rule__TypeDefinition__IdentifierAssignment_0");
			...
			builder.put(grammarAccess.getFunctionTypeAccess().getTypeIdentifierAssignment_3(), "rule__FunctionType__TypeIdentifierAssignment_3");
			...
			builder.put(grammarAccess.getFunctionDeclarationAccess().getTypeIdentifierAssignment_4(), "rule__FunctionDeclaration__TypeIdentifierAssignment_4");
			...
			builder.put(grammarAccess.getVariableAccess().getIdentifierAssignment_1(), "rule__Variable__IdentifierAssignment_1");
